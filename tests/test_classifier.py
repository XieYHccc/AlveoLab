...
if __name__ == '__main__':
    ...
    # filtered_colors = ['black' for p, color in zip(point_ids, peak_colors) if p is not None]
    ...
    # # plotter.add_legend(filtered_labels, bcolor="gray", face=pv.Arrow(), loc="upper right", size=(0.2, 0.2))
